...
python3 clinician_mailing_list.py \
  --center-zip 80302 \
  --radius-miles 20 \
  --taxonomies "Psychologist,Clinical Psychologist,Counseling Psychologist,Professional Counselor,Mental Health Counselor" \
...
| `--taxonomies` | Comma-separated NPI taxonomy descriptions to search | Psychologist, Clinical Psychologist, Counseling Psychologist, Professional Counselor, Mental Health Counselor |
...
descriptions (the exact strings the registry indexes on):

- **Psychologist** → `Psychologist`, `Clinical Psychologist`, `Counseling Psychologist`
- **Licensed Professional Counselor** → `Professional Counselor`
- **Mental Health Counselor** → `Mental Health Counselor`

Edit `--taxonomies` to add/remove specialties for future trainings (e.g.
